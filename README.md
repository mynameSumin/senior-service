...
> 배포된 서비스는 [GitHub Actions로 매일 자동 실행되는 크롤러](#크롤러-자동화-github-actions)가
> 데이터를 계속 채워두고 있어, 별도로 크롤러를 돌리거나 설정할 필요 없이 배포 링크에
> 들어가시면 바로 사용해 보실 수 있습니다. 아래의 로컬 실행/크롤러 안내는 직접 개발 환경을
> 띄워보고 싶을 때만 참고해 주세요.

## 기획

노션에 정리해두었습니다. 바로가기를 클릭해 확인하실 수 있습니다.
[notion 바로가기](https://app.notion.com/p/388f3b205f1e80dcbfd0e2cdcd0ab73d?source=copy_link)
